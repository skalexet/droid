...
function setupCheckPoints(level, checkPoints) {
...
export function createLevelLoader(entityFactory) { 
	return function loadLevel(name) {
		...
		.then(levelSpec => Promise.all([
			...
			loadCheckPoints(levelSpec.checkPoints)
		]))
		.then(([levelSpec, backgroundSprites, musicPlayer, patterns, checkPoints]) => { 
			...
			setupTriggers(levelSpec, level);	 
	 		setupBehavior(level);
			setupCheckPoints(level, checkPoints);
